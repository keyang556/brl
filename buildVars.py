...
addon_info = AddonInfo(
	...
	addon_name="cjkBrailleEnhancements",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("CJK Braille Enhancements"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""Braille enhancements for continuous CJK text such as Chinese:
text wrap at CJK character boundaries or with GMouse style overlapping panning,
and optional spaces between Chinese characters, Latin letters and numbers."""),
	# version
	addon_version="1.0.0",
...
* Optional spaces between Chinese characters, Latin letters and numbers in Chinese braille (NVDA issue #20726)."""),
	# Author(s)
	addon_author="Keyang556",
	# URL for the add-on documentation support
	addon_url="https://github.com/keyang556/brl",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/keyang556/brl",
...
pythonSources: list[str] = ["addon/globalPlugins/cjkBrailleEnhancements/*.py"]
